...
type Topic={tag:string;event_count:number;source_count:number;position_count:number;latest_subject_date:string|null;max_significance:number;tags:string[]};
