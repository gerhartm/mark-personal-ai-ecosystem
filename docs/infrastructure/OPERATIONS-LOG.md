...
- Recovery mirror: refreshed `/root/mark-v2-docs/` from the accepted tracked repository, verified all 257 file hashes, and retained the previous mirror as `/root/mark-v2-docs.pre-20260905T095230Z`.
